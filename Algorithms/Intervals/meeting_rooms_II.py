...
def min_meeting_days(intervals: list[list[int]])-> int:
    pass
...
print(min_meeting_days([(0,40),(5,10),(15,20)]))  # 2
print(min_meeting_days([(4,9)]))                  # 1
print(min_meeting_days([(5,8),(9,15)]))           # 1
print(min_meeting_days([(0,8),(8,10)]))           # 1
print(min_meeting_days([]))                       # 0
print(min_meeting_days([(0,1),(1,2),(2,3)]))      # 1
print(min_meeting_days([(0,10),(2,5),(4,6)]))     # 3
print(min_meeting_days([(1,4),(1,4),(1,4)]))      # 3
print(min_meeting_days([(1,5),(1,3),(1,2),(1,4)]))      # 4
print(min_meeting_days([(0,5),(1,5),(2,5),(3,5)]))      # 4
print(min_meeting_days([(0,5),(5,10),(4,6)]))      # 2
print(min_meeting_days([(0,1_000_000),(1,2),(2,3),(999_999,1_000_000)]))      # 2
print(min_meeting_days([(0,10),(2,8),(3,7),(4,6)]))      # 4
print(min_meeting_days([(0,2),(2,4),(4,6),(1,3),(3,5)]))      # 2
print(min_meeting_days([(0,1),(0,2),(1,2)]))      # 2
print('------------------------------------------------------')
